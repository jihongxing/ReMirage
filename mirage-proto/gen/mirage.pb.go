...
type HeartbeatRequest struct {
	...
	// 新增：黑名单统计
	BlacklistCount     int64 `protobuf:"varint,14,opt,name=blacklist_count,json=blacklistCount,proto3" json:"blacklist_count,omitempty"`
	BlacklistUpdatedAt int64 `protobuf:"varint,15,opt,name=blacklist_updated_at,json=blacklistUpdatedAt,proto3" json:"blacklist_updated_at,omitempty"`
	// 新增：安全状态
	SecurityState int32 `protobuf:"varint,16,opt,name=security_state,json=securityState,proto3" json:"security_state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HeartbeatRequest) GetBlacklistCount() int64 {
	if x != nil {
...
func (x *HeartbeatRequest) GetBlacklistUpdatedAt() int64 {
	if x != nil {
		return x.BlacklistUpdatedAt
	}
	return 0
}

func (x *HeartbeatRequest) GetSecurityState() int32 {
	if x != nil {
...
type StrategyPush struct {
	...
	// 新增：安全状态
	SecurityState int32 `protobuf:"varint,7,opt,name=security_state,json=securityState,proto3" json:"security_state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StrategyPush) GetSecurityState() int32 {
	if x != nil {
		return x.SecurityState
	}
	return 0
...
const file_mirage_proto_rawDesc = "" +
	...
	"\x10assigned_cell_id\x18\x03 \x01(\tR\x0eassignedCellId\"\xf6\x04\n" +
	...
	"\x0fblacklist_count\x18\x0e \x01(\x03R\x0eblacklistCount\x120\n" +
	"\x14blacklist_updated_at\x18\x0f \x01(\x03R\x12blacklistUpdatedAt\x12%\n" +
	"\x0esecurity_state\x18\x10 \x01(\x05R\rsecurityState\"}\n" +
	...
	"\rBlacklistPush\x125\n" +
	"\aentries\x18\x01 \x03(\v2\x1b.mirage.BlacklistEntryProtoR\aentries\"\x97\x02\n" +
	"\fStrategyPush\x12#\n" +
	...
	"templateId\x12%\n" +
	"\x0esecurity_state\x18\a \x01(\x05R\rsecurityState\"M\n" +
	"\tQuotaPush\x12'\n" +
